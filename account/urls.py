...
urlpatterns = [
    ...
    path('password_reset_done/', TemplateView.as_view(template_name='account/user/password_reset_done.html'), name='password_reset_done'),
    path('password_reset_complate/', TemplateView.as_view(template_name='account/user/password_reset_complate.html'), name='password_reset_complate'),
