...
from . import views
from .forms import PwdForgotConfirmForm, PwdForgotForm, UserLoginForm
...
urlpatterns = [
    ...
    path(
        ...
        auth_views.PasswordResetView.as_view(
            template_name="account/password_forgot/password_forgot_form.html",
            ...
            form_class=PwdForgotForm,
        ),
        name="password_forgot",
    ),
    path(
        "password_forgot_confirm/<uidb64>/<token>/",
        auth_views.PasswordResetConfirmView.as_view(
            template_name="account/password_forgot/password_forgot_confirm.html",
            success_url=reverse_lazy("account:password_forgot_complate"),
            form_class=PwdForgotConfirmForm,
        ),
        name="password_forgot_confirm",
    ),
    path(
        "password_forgot_done/",
        TemplateView.as_view(
            template_name="account/password_forgot/password_forgot_done.html"
        ),
        name="password_forgot_done",
    ),
    path(
        "password_forgot_complate/",
        TemplateView.as_view(
            template_name="account/password_forgot/password_forgot_complate.html"
        ),
        name="password_forgot_complate",
    ),
