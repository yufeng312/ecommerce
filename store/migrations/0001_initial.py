        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        max_length=255, unique=True, verbose_name="商品分类名称"
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        max_length=255, unique=True, verbose_name="商品名称"
                    ),
                ),
                ("slug", models.SlugField(max_length=255, unique=True)),
                (
                ...
                (
                    "is_discount",
                    models.BooleanField(default=False, verbose_name="是否打折"),
                ),
                ("is_active", models.BooleanField(default=True)),
                (
                    "discount",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        max_length=255, unique=True, verbose_name="商品类型名称"
                    ),
                ),
                ("is_active", models.BooleanField(default=True)),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "alt_text",
                    models.CharField(
                        blank=True, max_length=255, null=True, verbose_name="图片描述"
                    ),
                ),
                (
                    "is_feature",
                    models.BooleanField(default=False, verbose_name="商品主图"),
                ),
                ("create_time", models.DateTimeField(auto_now_add=True)),
                ("update_time", models.DateTimeField(auto_now=True)),
                (
