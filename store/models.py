...
class Category(MPTTModel):
    ...
    name = models.CharField(verbose_name="商品分类名称", max_length=255, unique=True)
...
class ProductType(models.Model):
    ...
    name = models.CharField(verbose_name="商品类型名称", max_length=255, unique=True)
    is_active = models.BooleanField(default=True)
...
class Product(models.Model):
    ...
    name = models.CharField(
        verbose_name="商品名称", max_length=255, unique=True, null=False, blank=False
    )
    slug = models.SlugField(max_length=255, unique=True)
...
class ProductSpecificationValue(models.Model):
    ...
    value = models.CharField(verbose_name="属性值", max_length=255)
...
class ProductImage(models.Model):
    ...
    image = models.ImageField(
        verbose_name="商品图片", upload_to="images", default="images/default.png"
    )
    alt_text = models.CharField(
        verbose_name="图片描述", max_length=255, null=True, blank=True
    )
